...
$(window).load(function () {
    ...
    $(".sub_productos").hover(
        function () {
            gsap.to($(this).find('.sub_productos_icon'), { scale: 1.1, duration: 0.5, ease: "sine.inOut" });
            gsap.to($(this).find('.sub_productos_img'), { scale: 1.1, duration: 0.3, ease: "sine.inOut" });
            gsap.to($(this).find('.sub_productos_circle1'), { scale: 1.2, opacity: 0, duration: 0.8, ease: "sine.inOut" });
        }, function () {
            gsap.to($(this).find('.sub_productos_icon'), { scale: 1, duration: 0.5, ease: "sine.inOut" });
            gsap.to($(this).find('.sub_productos_img'), { scale: 1, duration: 0.3, ease: "sine.inOut" });
            gsap.to($(this).find('.sub_productos_circle1'), { scale: 1, opacity: 1, duration: 0.8, ease: "sine.inOut" });
        }
    );
    ...
    $(".p1").click(function () {
        gsap.to(window, 0, { scrollTo: { y: ".producto1", offsetY: 450 } });
        gsap.to('.nuestros_main', { "margin-bottom": "0px", duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p1', { opacity: 1, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p2,.p3,.p4', { opacity: 0.2, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.producto2,.producto3,.producto4', {
            height: "0px", "background": "#80A0C1", "padding-top": "0px", "padding-bottom": "0px", duration: 0.5
        });
        gsap.to('.producto1', {
            height: "auto", "background": "#e1f0ff", "padding-top": "50px", "padding-bottom": "50px", duration: 1, ease: "sine.inOut",
            onComplete: function () {
    ...
    $(".p2").click(function () {
        gsap.to(window, 0, { scrollTo: { y: ".producto1", offsetY: 450 } });
        gsap.to('.nuestros_main', { "margin-bottom": "0px", duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p2', { opacity: 1, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p1,.p3,.p4', { opacity: 0.2, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.producto1,.producto3,.producto4', {
            height: "0px", "background": "#80A0C1", "padding-top": "0px", "padding-bottom": "0px", duration: 0.5
        });
        gsap.to('.producto2', {
            height: "auto", "background": "#e1f0ff", "padding-top": "50px", "padding-bottom": "50px", duration: 1, ease: "sine.inOut",
    ...
    $(".p3").click(function () {
        gsap.to(window, 0, { scrollTo: { y: ".producto1", offsetY: 450 } });
        gsap.to('.nuestros_main', { "margin-bottom": "0px", duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p3', { opacity: 1, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p2,.p1,.p4', { opacity: 0.2, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.producto1,.producto2,.producto4', {
            height: "0px", "background": "#80A0C1", "padding-top": "0px", "padding-bottom": "0px", duration: 0.5
        });
        gsap.to('.producto3', {
            height: "auto", "background": "#e1f0ff", "padding-top": "50px", "padding-bottom": "50px", duration: 1, ease: "sine.inOut",
    ...
    $(".p4").click(function () {
        gsap.to(window, 0, { scrollTo: { y: ".producto1", offsetY: 450 } });
        gsap.to('.nuestros_main', { "margin-bottom": "0px", duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p4', { opacity: 1, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p1,.p3,.p2', { opacity: 0.2, duration: 0.5, ease: "sine.inOut" });
        gsap.to('.producto1,.producto3,.producto2', {
            height: "0px", "background": "#80A0C1", "padding-top": "0px", "padding-bottom": "0px", duration: 0.5
        });
        gsap.to('.producto4', {
            height: "auto", "background": "#e1f0ff", "padding-top": "50px", "padding-bottom": "50px", duration: 1, ease: "sine.inOut",
    ...
    $(".productos_close").click(function () {

        gsap.to('.nuestros_main', { "margin-bottom": "100px", duration: 0.5, ease: "sine.inOut" });
        gsap.to('.p1,.p2,.p3,.p4', { opacity: 1, duration: 0.5, ease: "sine.inOut" });

        setTimeout(() => {
            gsap.to(window, 0.5, { scrollTo: { y: ".nuestros", offsetY: 300 } });
            ScrollTrigger.refresh();
        }, 400);

        gsap.to('.producto1,.producto2,.producto3,.producto4', {
            height: "0px", "padding-top": "0px", "padding-bottom": "0px", duration: 0.5, ease: "sine.inOut"
        });
    })
