...
$(window).load(function () {
    ...
    $(".nuestros_productos2").hover(
        function () {
            gsap.to($(this).find('.nuestros_productos_icon2'), { scale: 1.1, duration: 0.5, ease: "sine.inOut" });
            gsap.to($(this).find('.nuestros_productos_img2'), { scale: 1.1, duration: 0.3, ease: "sine.inOut" });
            gsap.to($(this).find('.nuestros_productos_circle2'), { scale: 1.2, opacity: 0, duration: 0.8, ease: "sine.inOut" });
        }, function () {
            gsap.to($(this).find('.nuestros_productos_icon2'), { scale: 1, duration: 0.5, ease: "sine.inOut" });
            gsap.to($(this).find('.nuestros_productos_img2'), { scale: 1, duration: 0.3, ease: "sine.inOut" });
            gsap.to($(this).find('.nuestros_productos_circle2'), { scale: 1, opacity: 1, duration: 0.8, ease: "sine.inOut" });
        }
    );


    gsap.to(".nuestros_productos2", { y: 300, opacity: 0, duration: 0 });
    ...
    tl1.to(".nuestros_productos2", { y: 0, opacity: 1, duration: 1, stagger: 0.1, ease: "sine.inOut" })
